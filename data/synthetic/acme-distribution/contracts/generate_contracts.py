...
freight_sections = [
    ("1. Parties", "This Freight Services Agreement (\"Agreement\") is entered into between "
     "Acme Distribution Inc. (\"Customer\") and Dominion Freight Carriers Ltd. (\"Carrier\"), "
     "effective as of January 1, 2024."),
    ("2. Services", "Carrier shall provide truckload and less-than-truckload freight services "
    ...
    ("3. Term", "This Agreement shall commence on the Effective Date and continue for an "
     "initial term of thirty-six (36) months (the \"Initial Term\")."),
    ("4. Renewal", "Unless either Party provides the other with written notice of "
    ...
    ("5. Rates and Fuel Surcharge", "Base rates are set out in Schedule A and are subject to a "
    ...
    ("6. Termination for Convenience", "Except as set out in Section 4, neither Party may "
     "terminate this Agreement for convenience during the Initial Term or any Renewal Term."),
    ("7. Confidentiality", "Each Party shall maintain the confidentiality of the other Party's "
    ...
    ("8. Governing Law", "This Agreement shall be governed by the laws of the Province of "
     "Ontario and the federal laws of Canada applicable therein."),
]

materials_sections = [
    ("1. Parties", "This Raw Materials Supply Agreement (\"Agreement\") is entered into "
     "between Steelcore Materials Ltd. (\"Supplier\") and Acme Distribution Inc. "
     "(\"Customer\"), effective as of April 1, 2025."),
    ("2. Products and Pricing", "Supplier shall supply the components listed in Schedule A "
     "(\"Products\") at the unit prices set out therein (\"Base Prices\")."),
    ("3. Annual Price Adjustment", "Commencing on the first anniversary of the Effective Date "
     ...
     "anniversary date."),
    ("4. Volume Commitment", "Customer agrees to purchase not less than eighty-five percent "
     "(85%) of its annual requirements for the Products from Supplier during each Contract "
     "Year."),
    ("5. Delivery", "Supplier shall deliver Products to Customer's designated facilities in "
     "accordance with the delivery schedule set out in Schedule B, subject to standard lead "
     "times of ten (10) business days."),
    ("6. Term and Termination", "This Agreement has an initial term of three (3) years from "
    ...
    ("7. Warranty", "Supplier warrants that all Products will conform to the specifications "
